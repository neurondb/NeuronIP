...
const actions = [
  {
    name: microcopy.dashboard.quickActions.semanticSearch,
    href: '/semantic',
    icon: MagnifyingGlassIcon,
    color: 'text-blue-600 dark:text-blue-400',
  },
  {
    name: microcopy.dashboard.quickActions.warehouseQuery,
    href: '/warehouse',
    icon: CubeIcon,
    color: 'text-green-600 dark:text-green-400',
  },
  {
    name: microcopy.dashboard.quickActions.runWorkflow,
    href: '/workflows',
    icon: CommandLineIcon,
    color: 'text-purple-600 dark:text-purple-400',
  },
  {
    name: microcopy.dashboard.quickActions.complianceCheck,
    href: '/compliance',
    icon: Cog6ToothIcon,
  ...
  return (
    <Card>
      <div className="p-4 sm:p-5">
        <h3 className="text-base sm:text-lg font-semibold mb-3">{microcopy.dashboard.quickActions.title}</h3>
        <motion.div
